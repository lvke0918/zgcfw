...
<title>中关村企业服务网- <?php echo L('member','','member').L('manage_center');?></title>
...
$(function(){
	...
	$("#username").formValidator({onshow:"<?php echo L('input').L('username');?>",onfocus:"<?php echo L('username').L('between_2_to_40');?>"}).inputValidator({min:2,max:40,onerror:"<?php echo L('username').L('between_2_to_40');?>"}).regexValidator({regexp:"ps_username",datatype:"enum",onerror:"<?php echo L('username').L('format_incorrect');?>"}).ajaxValidator({
	    type : "get",
		url : "",
...
<form method="post" action="" id="myform">
	...
	<div class="col-left form-login form-reg">
    	...
    	<div class="input"><label>企业名称：</label><input type="text" id="username" name="username" size="36" class="input-text"></div>
		...
		<div class="input"><label>联系人：</label><input type="text" id="nickname" name="nickname" size="36" class="input-text"></div>
		<div class="input"><label>联系人电话：</label><input type="text" id="mobile" name="mobile" size="36" class="input-text"></div>
		<?php if($member_setting['choosemodel']) { ?>
			<!--是否开启选择会员模型选项-->
			<script language="JavaScript">
			<!--
