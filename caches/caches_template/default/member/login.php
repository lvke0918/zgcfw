...
$(function(){
	...
	$("#username").formValidator({onshow:"<?php echo L('input').L('username');?>",onfocus:"<?php echo L('between_2_to_40');?>"}).inputValidator({min:2,max:40,onerror:"<?php echo L('between_2_to_40');?>"}).regexValidator({regexp:"ps_username",datatype:"enum",onerror:"<?php echo L('username').L('format_incorrect');?>"});
...
<input type="hidden" name="forward" id="forward" value="<?php echo $forward;?>">
      ...
      <!-- <div class="input">
        ...
        <div class="hr"><hr /></div>
        <div class="reg">您还没有注册中关村企业服务网会员？<br />
