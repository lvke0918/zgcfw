...
//			}
    ...
    public function login1(){
        ...
        $a= pc_base::load_model('user_model');
        $result = $a->select();
...
echo $v['field1'].'<br>';
            ...
            $userinfo['username'] = (isset($v['field1']) && is_username($v['field1'])) ? $v['field1'] : $v['field1'].time();
            $userinfo['nickname'] = (isset($v['field2']) && is_username($v['field2'])) ? $v['field2'] : '';


            $email=$v['field3'].'@zgcfw.org.cn';
            $userinfo['email'] = (isset($email) && is_email($email)) ? $email : time().'@zgcfw.org.cn';
            $userinfo['password'] = isset($v['field3']) ? $v['field3'] : exit('3');
            ...
            //手机强制验证
                ...
                //获取验证码，直接通过POST，取mobile值
                $userinfo['mobile'] = isset($v['field3']) ? $v['field3']: '';
